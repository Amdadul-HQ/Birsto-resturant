...
const PizzaMenu = () => {
    ...
    return (
        <section className="container mx-auto mb-28">
            ...
            <Link to='/order/pizza'><button className="text-[#1F2937] text-xl font-medium text-center py-5 px-8 border-b-2 rounded-lg border-black">ORDER YOUR FAVOURITE FOOD</button></Link>
            </div>
        </section>
    );
};
