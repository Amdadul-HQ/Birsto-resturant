                    ...
                    <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                        {
                            menu && menu.map((item,index)=> <tr key={item._id}>
                                ...
                                <div className="flex items-center px-12 gap-x-6">
                                        <Link to={`/dashboard/update/${item._id}`} className=" text-center flex justify-center items-center rounded-md transition-colors duration-200 dark:hover:text-red-500 w-12 h-12 bg-[#e6c044] text-white dark:text-gray-300 hover:text-green-500 focus:outline-none">
