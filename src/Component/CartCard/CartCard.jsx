...
const CartCard = ({items}) => {
    ...
    return (
        <div className='w-full bg-[#F3F3F3] font-inter'>
            <div className='w-full'>
                <img className='w-full' src={image} alt="" />
            </div>
            <div className='mt-4 mx-auto pb-6 flex flex-col justify-center'>
                ...
                <button className='text-xl mt-4 text-[#BB8506] font-medium px-7 border-b-4 border-[#BB8506] hover:border-[#1F2937] rounded-lg hover:bg-[#1F2937] bg-[#E8E8E8] py-5'>ADD TO CART</button>
            </div>
        </div>
    );
};
